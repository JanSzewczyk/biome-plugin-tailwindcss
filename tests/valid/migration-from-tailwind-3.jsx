...
export const FlexV4 = () => <div className="grow grow-0 shrink shrink-0 basis-0">v4 flex utilities</div>;

// v4 replacements for renamed text/overflow utilities
export const TextV4 = () => <p className="text-ellipsis overflow-hidden whitespace-nowrap">v4 text utilities</p>;

// v4 replacements for renamed decoration utilities
export const DecorationV4 = () => (
  <span className="box-decoration-slice box-decoration-clone underline">v4 decoration utilities</span>
);
...
export const OutlineV4 = () => (
  <button className="focus:outline-hidden focus:outline-2 focus:outline-blue-500">v4 outline utilities</button>
);
...
export const BlurV4 = () => <div className="blur-xs blur-md blur-lg blur-xl blur-none">v4 blur utilities</div>;
...
export const DropShadowV4 = () => (
  <div className="drop-shadow-xs drop-shadow-md drop-shadow-lg drop-shadow-none">v4 drop-shadow utilities</div>
);
